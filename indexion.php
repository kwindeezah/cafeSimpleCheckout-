...
<body>
    ...
    <div class="tm-row">
      ...
      <div class="tm-right">
        <main class="tm-main">
          ...
          <!-- end Contact Page -->
          <!-- Cart Page -->
          <div id="cart" class="tm-page-content tm-black-bg">
            <h2 class="tm-text-primary tm-special-item-title">Shopping Cart</h2>
            <div class="tm-special-item-description">
              <p class="tm-list-item-price" id="total-amount">Total: #
                <?php 
            ...
            <form action="checkout.php" method="post">
              ...
              <button type="submit" class="tm-btn-primary tm-align-right" name="buy-now">Buy Now</button>
              <!-- Hidden input to pass the total amount to checkout.php -->
  ...
  <script>
    ...
    //     let total = 0;
    //     cart.forEach(item => {
    //       cartDisplay.innerHTML += `<div class="tm-special-item-description"><p class="tm-list-item-price">${item.name} - #${item.price.toFixed(2)}</p></div>`;
    //         total += item.price;
    //     });
